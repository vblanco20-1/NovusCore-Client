...
void UIPanel::RegisterType()
{
    ...
    assert(r >= 0);
    {
        ...
        r = ScriptEngine::RegisterScriptClassFunction("void SetColor(float r, float g, float b, float a)", asMETHOD(T, asd)); assert(r >= 0);
    }
}
...
void UIPanel::asd(f32 r, f32 g, f32 b, f32 a)
{
